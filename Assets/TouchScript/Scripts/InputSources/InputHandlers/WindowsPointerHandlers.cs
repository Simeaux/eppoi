...
{
    /// <summary>
    /// Windows 8 pointer handling implementation which can be embedded to other (input) DBClass. Uses WindowsTouch.dll to query native touches with WM_TOUCH or WM_POINTER APIs.
    /// </summary>
