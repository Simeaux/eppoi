...
namespace Mapbox.Unity.Map
{
    ...
    public class AbstractMap : MonoBehaviour, IMap
    {
        ...
        public virtual void Initialize(Vector2d latLon, int zoom)
        {
            ...
            //Debug.Log("----1-" + String.Format(CultureInfo.InvariantCulture, "{0},{1}", latLon.x, latLon.y) + "----");
        ...
        {
            //Debug.Log("----2-" + String.Format(CultureInfo.InvariantCulture, "{0},{1}", centerLatitudeLongitude.x, centerLatitudeLongitude.y) + "----");
